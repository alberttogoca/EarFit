...
//this archive should go in public/images but I had a problem with relative routes and nextjs can't find the archive

export const GithubSVG = (): JSX.Element => (
  <svg
...
export const LinkedInSVG = (): JSX.Element => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    href="http://www.w3.org/1999/xlink"
    width="107"
